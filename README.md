...
> [!NOTE]
> This is just a NuGet package of the original [PresentMonFps](https://github.com/lemutec/PresentMonFps) library maintained for the [Lenovo Legion Toolkit](https://github.com/LenovoLegionToolkit-Team/LenovoLegionToolkit) project.
